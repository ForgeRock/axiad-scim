...
1. Test `User` provisioning by creating a user in ForgeRock and make sure it is provisioned in the Axiad Cloud and all the mappings are working as expected.
2. Test `Role` provisioning by creating a role in ForgeRock and make sure it is provisioned in the Axiad Cloud and all the mappings are working as expected.
